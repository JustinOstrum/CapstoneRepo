...
public class YellowFruitScript : MonoBehaviour, IPooledObject
{
    ...
    //private animator variable
    Animator anim;

    private void Awake()
    {
        rb = GetComponent<Rigidbody>(); //grabs the rigidbody component
        anim = gameObject.GetComponent<Animator>(); //grabs the animator component
    }
    ...
    public void OnObjectSpawn() //called by the object pooler through the interface
    {
        ...
        anim.Play("FruitGrow"); // rusn the grow animation
